...
class ZhujiajiaoSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://www.tripadvisor.cn/Attraction_Review-g308272-d1143615-Reviews-Former_French_Concession-Shanghai.html',
    ]
    ...
    def parse(self, response):
        ...
        # 创建 浏览器 并访问 url
        driver, wait = self.selenium_chrome(response.url)
        # 切换语种
        ...
        while 1:
            ...
            for commit_p in pbody:
                ...
                # title
                title = '_'.join(commit_p.xpath('./div[2]//div/a/span/text()'))
                # 环比
...
if __name__ == '__main__':
    ...
    cmdline.execute('scrapy crawl fazhujie_2'.split())
